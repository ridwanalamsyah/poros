...
export function NotFoundPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-24 text-center">
      ...
      <p className="text-muted mt-4">Kalau yakin link-nya benar, kirim screenshot ke <a className="underline" href="mailto:hello@porosmagazine.id">hello@porosmagazine.id</a>.</p>
